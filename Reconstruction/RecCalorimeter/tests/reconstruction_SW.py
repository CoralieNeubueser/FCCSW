...
podioevent = FCCDataSvc("EventDataSvc", input="root://eospublic//eos/fcc/users/c/cneubuse/FccHcal/fullModelSim/combCalo/deltaEta.001/output_combCalo_pi0"+str(energy)+"GeV_bfield"+str(bfield)+"_eta"+str(eta)+"_part"+str(i)+".root")
...
towersEcal = SingleCaloTowerTool("towersEcal",
                             deltaEtaTower = 0.001, deltaPhiTower = 2*pi/512.,
...
createEcalClusters = CreateCaloClustersSlidingWindow("CreateEcalClusters",
                                                 ...
                                                 nEtaWindow = 55, nPhiWindow = 55,
                                                 nEtaPosition = 25, nPhiPosition = 25,
                                                 nEtaDuplicates = 25, nPhiDuplicates = 25,
                                                 nEtaFinal = 55, nPhiFinal = 55,
                                                 energyThreshold = 1,
                                                 OutputLevel = DEBUG)
