...
# noise files
pileupBarrelNoisePath = "/afs/cern.ch/work/c/cneubuse/public/FCChh/inBfield/noiseBarrel_PU"+str(int(mu))+".root"
...
noisePerCell = CreateFCChhCaloNoiseLevelMap("noisePerCell", 
                                            ...
                                            outputFileName="/afs/cern.ch/work/c/cneubuse/public/FCChh/inBfield/cellNoise_map_electronicsNoiseLevel_forPU"+str(int(mu))+"_recTopo.root",
                                            OutputLevel=DEBUG)
