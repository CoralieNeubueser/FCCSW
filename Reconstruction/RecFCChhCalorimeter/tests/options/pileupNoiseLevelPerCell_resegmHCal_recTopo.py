...
# noise files
pileupBarrelNoisePath = "/afs/cern.ch/work/c/cneubuse/public/FCChh/inBfield/resegmentedHCal/noiseBarrel_PU"+str(int(mu))+".root"
...
noisePerCell = CreateFCChhCaloNoiseLevelMap("noisePerCell", 
                                            ...
                                            readoutNamesVolumes=[],
                                            outputFileName="/afs/cern.ch/work/c/cneubuse/public/FCChh/inBfield/resegmentedHCal/cellNoise_map_electronicsNoiseLevel_forPU"+str(int(mu))+"_recTopo.root",
                                            OutputLevel=DEBUG)
